...
function AddStatDialog(props) {
    var moment = require('moment');

    const styles = useStyles();

    const { isOpen, closeDialogHandler } = props;
    ...
    useEffect(() => {
        ...
        //DATE COMPLETED
        if (util.isBeforeDay(firstSolved, puzzleDate)) {
    ...
    function handleSave() {
        const stat = {
            puzzle_date: util.formatMomentToDateString(puzzleDate),
