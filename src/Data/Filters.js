...
const emptyFilters = {
    weekday: {key: 0, label: 'weekday: ', value: ''},
    puzzle_date_from: {key: 1, label: 'puzzle date from: ', value: ''},
    puzzle_date_to: {key: 2, label: 'puzzle date to: ', value: ''},
    num_lookups: {key: 3, label: 'num lookups: ', value: ''},
    source: {key: 4, label: 'source: ', value: ''},
}

export default function Filters(props) {
    const styles = useStyles();

    const {isFilterOpen, filterHandler} = props;
