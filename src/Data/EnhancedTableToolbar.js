...
function EnhancedTableToolbar(props) {
    ...
    const { numSelected, deleteClickedHandler, filterHandler, dense, changeDenseHandler } = props;
        ...
        <Fragment>
            ...
            >
                <div className={styles.toolbarDiv}>
                    ...
                    <AddStatDialog isOpen={isDialogOpen} closeDialogHandler={handleCloseDialog}/>
                </div>
            </Toolbar>
        </Fragment>
    )};
